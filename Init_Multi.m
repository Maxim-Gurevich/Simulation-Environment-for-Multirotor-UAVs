...
%--------------------------------------------------------------------------
t_sim = 1/1000;             % Simulation period [s]
t_control_2 = t_sim*5;      % Attitude Controller/state estimation period [s] 1/200
t_control = t_control_2*4;    % Position Controller/state estimation period [s] 1/50
sim_time = 12;            % Duration of simulation [sec]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Noise_flag = 1;                 % Set to 1 for sensor/estimation noise, to 0 for no noise
Coriolis_correction = 0;        % Set to 1 to cancel omega x (J*omega) term in control law, 0 if not
...
Xi_init = [0;0;-2];              % Initial position in Inertial frame for 6DOF block [m]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %Gains for PID ([Ypos;Xpos;yaw;Zpos])
% Kp_1  = .0*[.0;-0;2;-100];
% Ki_1  = 0*[1;-1;1;-1];
% Kd_1  = -.0*[0;0;1;-50];
% Kff_1 = [0;0;0;0];
% Kpass_1=[0;0;0;0];%command pass through yaw and Zpos
% anti_windup_1=.00001; %integral absolute value saturation limit

% %Gains for PID ([roll;pitch;yaw;Zpos])
% Kp_2  = [.0;-0;.001;-0];
% Ki_2  = 0*[1;-1;1;-1];
% Kd_2  = -0*[0;-0;0;-0];
% Kff_2 = [0;0;0;5.4];
% anti_windup_2=100; %integral absolute value saturation limit
